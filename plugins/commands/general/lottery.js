...
const langData = {
    "vi_VN": {
        ...
        "invalidNumberBet": "Đã có lỗi sảy ra! Số đặt cược chỉ nằm trong khoảng 1 - {limitNumber}",
        ...
        "betSuccess": "Bạn đã đặt cược thành công vào số {numberBet} với mức cược là {bet}"
    }
}
